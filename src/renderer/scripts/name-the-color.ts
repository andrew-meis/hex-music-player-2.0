export const ntc = {
  init: function () {
    let color: string, rgb: number[], hsl: string[] | number[];
  ...
  name: function (color: string) {
    ...
    for (let i = 0; i < ntc.names.length; i++) {
      ...
      ndf1 =
        Math.pow(r - Number(ntc.names[i][3]), 2) +
        Math.pow(g - Number(ntc.names[i][4]), 2) +
        Math.pow(b - Number(ntc.names[i][5]), 2);
      ndf2 =
        Math.abs(Math.pow(h - Number(ntc.names[i][6]), 2)) +
        Math.pow(s - Number(ntc.names[i][7]), 2) +
        Math.abs(Math.pow(l - Number(ntc.names[i][8]), 2));
      ndf = ndf1 + ndf2 * 2;
      if (df < 0 || df > ndf) {
        df = ndf;
        cl = i;
  ...
  names: [
    ...
    ['905E26', 'Afghan Tan', 'Brown'], // Yellow
    ['5D8AA8', 'Air Force Blue', 'Blue'],
    ['BEB29A', 'Akaroa', 'Brown'], // Yellow
    ['F2F0E6', 'Alabaster', 'Grey'],
    ['E1DACB', 'Albescent White', 'Grey'], // Yellow
    ['954E2C', 'Alert Tan', 'Brown'], // Orange
    ['F0F8FF', 'Alice Blue', 'Blue'],
    ['E32636', 'Alizarin', 'Red'],
    ['1F6A7D', 'Allports', 'Blue'],
    ['EED9C4', 'Almond', 'Brown'], // Yellow
    ...
    ['7D9D72', 'Amulet', 'Green'],
    ['8CCEEA', 'Anakiwa', 'Blue'],
    ['6C461F', 'Antique Brass', 'Brown'], // Orange
    ['FAEBD7', 'Antique White', 'White'],
    ['C68E3F', 'Anzac', 'Brown'], // Yellow
    ['D3A95C', 'Apache', 'Brown'], // Yellow
    ['66B348', 'Apple', 'Green'],
    ...
    ['B6935C', 'Barley Corn', 'Brown'], // Yellow
    ...
    ['3E8027', 'Bilbao', 'Green'],
    ['AE99D2', 'Bilbao Flower', 'Violet'],
    ['3F3726', 'Birch', 'Brown'], // Yellow
    ['D0C117', 'Bird Flower', 'Yellow'], // Green
    ['2F3C53', 'Biscay', 'Blue'],
    ['486C7A', 'Bismark', 'Blue'],
    ['B5AC94', 'Bison Hide', 'Brown'], // Yellow
    ['FFE4C4', 'Bisque', 'Brown'],
    ['3D2B1F', 'Bistre', 'Brown'],
    ['88896C', 'Bitter', 'Green'],
    ...
    ['C07C40', 'Brandy Punch', 'Brown'], // Orange
